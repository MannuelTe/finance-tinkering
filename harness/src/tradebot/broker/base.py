"""Broker interface and shared order/fill/position/bar types.

PURPOSE: Broker interface and shared order/fill/position/bar types.
INPUTS:  -
OUTPUTS: Broker Protocol and dataclasses used by every broker implementation.
"""
