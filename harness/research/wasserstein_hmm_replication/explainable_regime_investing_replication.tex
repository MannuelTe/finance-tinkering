...
\fancyhead[R]{\small Clean-room audit}
\fancyfoot[C]{\thepage}
\setlength{\headheight}{14pt}

\title{\textbf{Reproducing Explainable Regime-Aware Investing}\\
\large A Clean-Room Implementation and Reproducibility Audit}
...
The contribution of this paper is not another tuned variant. It is a clean-room replication with three goals:
...
\begin{table}[H]
\centering
\caption{Key clean-room assumptions required by omitted implementation details.}
