"""Show the orders the bot would place for a target portfolio, without any broker.
...
def main() -> None:
    ...
    parser.add_argument("--weights", default="SPY:0.6,TLT:0.4", help="symbol:weight pairs")
