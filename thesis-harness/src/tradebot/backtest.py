"""Constant-weight daily-rebalance backtester.

PURPOSE: Constant-weight daily-rebalance backtester.
INPUTS:  yfinance bars (or injected fetcher), target weights, instruments for FX conversion.
OUTPUTS: BacktestResult (NAV series, total return, CAGR, max drawdown, Sharpe).
"""
