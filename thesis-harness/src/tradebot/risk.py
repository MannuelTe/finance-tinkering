"""Pre-trade risk gate: kill switch and per-order notional cap.

PURPOSE: Pre-trade risk gate: kill switch and per-order notional cap.
INPUTS:  proposed orders, NAV, base-currency prices.
OUTPUTS: approved and rejected (order, reason) lists.
"""
