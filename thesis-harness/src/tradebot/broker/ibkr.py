"""Interactive Brokers broker (ib_async) with startup safety checks.

PURPOSE: Interactive Brokers broker (ib_async) with startup safety checks.
INPUTS:  settings (host, port, mode), tradebot.instruments registry.
OUTPUTS: positions, NAV, prices, FX, market-hours checks and order placement.
"""
