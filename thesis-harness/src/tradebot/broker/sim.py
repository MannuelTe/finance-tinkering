"""In-memory simulated broker for tests and backtests.

PURPOSE: In-memory simulated broker for tests and backtests.
INPUTS:  starting cash, prices set via set_price().
OUTPUTS: fills at the set price; tracks cash and positions.
"""
